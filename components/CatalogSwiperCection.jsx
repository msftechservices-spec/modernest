        ...
        <div className="py-8 lg:py-28">
            <div className="container grid pb-8 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 text-white opacity-80 gap-x-8">
                        <div>
                            <p>
                        ...
                        <div>
                            ...
                            <a href="" className="inline-flex items-center pt-4 text-lg font-bold text-accent hover:text-white transition-colors underline">View Gallery <TbArrowUpRight /> </a>
                        </div>
                    </div>
                </div>
            </div>
